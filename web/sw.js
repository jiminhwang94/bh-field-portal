...
const SHELL = [
  ...
  './js/drivemedia.js', './js/update.js', './js/drivesheet.js', './js/connect.js', './js/changes.js',
  ...
  './fonts/PretendardVariable.woff2',   // 현장은 오프라인이라 서체도 담아 둔다
];
